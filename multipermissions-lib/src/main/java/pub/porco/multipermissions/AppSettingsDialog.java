...
public class AppSettingsDialog {
    ...
    public static class Builder {
        ...
        @TargetApi(11)
        public Builder setContext(Object object){
            if(object instanceof Activity) {
                mActivityOrFragment = object;
                mContext = (Activity) object;
            }else if(object instanceof android.support.v4.app.Fragment){
                mActivityOrFragment = object;
                mContext = ((android.support.v4.app.Fragment)object).getContext();
            }else if(object instanceof android.app.Fragment){
                mActivityOrFragment = object;
                mContext = ((android.app.Fragment) object).getActivity();
            }
            return this;
        }
