...
public class EasyPermissions {
        ...
        for (Object object : receivers) {
            ...
            if (!denied.isEmpty()) {
                if (object instanceof PermissionCallbacks) {
                    ...
                    if(DefaultConfig.switcher) {
                        Activity activity = getActivity(object);
                        if (activity != null)
                            DefaultConfig.createSettingDialog(activity).build().show();
                    }
                }
            }
            ...
            if (!granted.isEmpty() && denied.isEmpty()) {
                runAnnotatedGrantMethods(object, requestCode);
            }
        }
    ...
    protected static void runAnnotatedGrantMethods(@NonNull Object object, int requestCode) {
            ...
            if (method.isAnnotationPresent(AfterPermissionGranted.class)) {
                ...
                if (ann.value() == requestCode) {
                    ...
                    try {
                        ...
                        if(DefaultConfig.switcher)
                            DefaultConfig.createErrorDialog(EasyPermissions.getActivity(object)).create().show();
                    }
                }
            }
        }
    ...
    protected static void checkCallingObjectSuitability(@Nullable Object object) {
        if (object == null) {
